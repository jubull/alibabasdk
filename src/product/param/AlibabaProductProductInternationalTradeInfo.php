...
class AlibabaProductProductInternationalTradeInfo extends SDKDomain {
    ...
    /**
     * @return mixed FOB价格货币，参见FAQ 货币枚举值
     */
    ...
    /**
     * @return mixed FOB计量单位，参见FAQ 计量单位枚举值
     */
    ...
    /**
     * @return mixed 付款方式，参见FAQ 付款方式枚举值
     */
    ...
    /**
     * @return mixed 最小起订量计量单位，参见FAQ 计量单位枚举值
     */
    ...
    /**
     * @return mixed 供货能力计量单位，参见FAQ 计量单位枚举值
     */
    ...
    /**
     * @return mixed 供货能力周期，参见FAQ 时间周期枚举值
     */
	...
	public function setArrayResult($arrayResult) {
		...
		if (array_key_exists ( "fobCurrency", $this->arrayResult )) {
		    $this->fobCurrency = $arrayResult['${paramType.paramName}'];
		}
		if (array_key_exists ( "fobMinPrice", $this->arrayResult )) {
		    $this->fobMinPrice = $arrayResult['${paramType.paramName}'];
		}
		if (array_key_exists ( "fobMaxPrice", $this->arrayResult )) {
		    $this->fobMaxPrice = $arrayResult['${paramType.paramName}'];
		}
		if (array_key_exists ( "fobUnitType", $this->arrayResult )) {
		    $this->fobUnitType = $arrayResult['${paramType.paramName}'];
		}
		if (array_key_exists ( "paymentMethods", $this->arrayResult )) {
		    $this->paymentMethods = $arrayResult['${paramType.paramName}'];
		}
		...
		if (array_key_exists ( "minOrderUnitType", $this->arrayResult )) {
		    $this->minOrderUnitType = $arrayResult['${paramType.paramName}'];
		}
		if (array_key_exists ( "supplyQuantity", $this->arrayResult )) {
		    $this->supplyQuantity = $arrayResult['${paramType.paramName}'];
		}
		if (array_key_exists ( "supplyUnitType", $this->arrayResult )) {
		    $this->supplyUnitType = $arrayResult['${paramType.paramName}'];
		}
		if (array_key_exists ( "supplyPeriodType", $this->arrayResult )) {
		    $this->supplyPeriodType = $arrayResult['${paramType.paramName}'];
		}
		if (array_key_exists ( "deliveryPort", $this->arrayResult )) {
		    $this->deliveryPort = $arrayResult['${paramType.paramName}'];
		}
		if (array_key_exists ( "deliveryTime", $this->arrayResult )) {
		    $this->deliveryTime = $arrayResult['${paramType.paramName}'];
		}
		if (array_key_exists ( "consignmentDate", $this->arrayResult )) {
		    $this->consignmentDate = $arrayResult['${paramType.paramName}'];
		}
		if (array_key_exists ( "packagingDesc", $this->arrayResult )) {
		    $this->packagingDesc = $arrayResult['${paramType.paramName}'];
		}
	}
}
