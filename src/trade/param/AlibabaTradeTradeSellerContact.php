...
class AlibabaTradeTradeSellerContact extends SDKDomain {
    ...
    */
    ...
    /**
     * @return mixed 发件人名称，在微供等分销场景下由分销商设置
     */
    ...
    /**
     * @return mixed 发件人电话，在微供等分销场景下由分销商设置
     */
	...
	public function setArrayResult($arrayResult) {
		...
		if (array_key_exists ( "wgSenderName", $this->arrayResult )) {
		    $this->wgSenderName = $arrayResult['${paramType.paramName}'];
		}
		if (array_key_exists ( "wgSenderPhone", $this->arrayResult )) {
		    $this->wgSenderPhone = $arrayResult['${paramType.paramName}'];
		}
	}
}
