...
use com\alibaba\p4p\param\AlibabaPpOpenClientResultOpenUnionOpGroupListResult;
...
class AlibabaCpsOpListCybUserGroupResult {
	 ...
	 *
	 * 设置结果
	 * @param \com\alibaba\p4p\param\AlibabaPpOpenClientResultOpenUnionOpGroupListResult $result
	 * 此参数必填
	 */
