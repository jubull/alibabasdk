...
class AlibabaOpenplatformTradeModelInternationalLogisticsInfo extends SDKDomain {
    ...
    */
    ...
    /**
     * @return mixed 发货方式。AIR(空运),SEA(海运),EXPRESS(快递),LAND(陆运),UNKNOWN(未知)
     */
    ...
    /**
     * @return mixed 相对时间单位。day(天),hour(时),second(秒)
     */
    ...
    /**
     * @return mixed 相对时间的开始点。pre_amount(预付款到帐),final_amount(尾款到帐)
     */
	...
	public function setArrayResult($arrayResult) {
		...
		if (array_key_exists ( "alternateAddress", $this->arrayResult )) {
		    $this->alternateAddress = $arrayResult['${paramType.paramName}'];
		}
		if (array_key_exists ( "carrier", $this->arrayResult )) {
		    $this->carrier = $arrayResult['${paramType.paramName}'];
		}
		...
		if (array_key_exists ( "faxArea", $this->arrayResult )) {
		    $this->faxArea = $arrayResult['${paramType.paramName}'];
		}
		if (array_key_exists ( "faxCountry", $this->arrayResult )) {
		    $this->faxCountry = $arrayResult['${paramType.paramName}'];
		}
		if (array_key_exists ( "insuranceFee", $this->arrayResult )) {
		    $this->insuranceFee = $arrayResult['${paramType.paramName}'];
		}
		...
		if (array_key_exists ( "logisticsFee", $this->arrayResult )) {
		    $this->logisticsFee = $arrayResult['${paramType.paramName}'];
		}
		...
		if (array_key_exists ( "mobileArea", $this->arrayResult )) {
		    $this->mobileArea = $arrayResult['${paramType.paramName}'];
		}
		if (array_key_exists ( "mobileCountry", $this->arrayResult )) {
		    $this->mobileCountry = $arrayResult['${paramType.paramName}'];
		}
		if (array_key_exists ( "port", $this->arrayResult )) {
		    $this->port = $arrayResult['${paramType.paramName}'];
		}
		if (array_key_exists ( "portCode", $this->arrayResult )) {
		    $this->portCode = $arrayResult['${paramType.paramName}'];
		}
		...
		if (array_key_exists ( "shipmentAbsoluteDate", $this->arrayResult )) {
		    $this->shipmentAbsoluteDate = $arrayResult['${paramType.paramName}'];
		}
		if (array_key_exists ( "shipmentAbsoluteZone", $this->arrayResult )) {
		    $this->shipmentAbsoluteZone = $arrayResult['${paramType.paramName}'];
		}
		if (array_key_exists ( "shipmentDateType", $this->arrayResult )) {
		    $this->shipmentDateType = $arrayResult['${paramType.paramName}'];
		}
		if (array_key_exists ( "shipmentMethod", $this->arrayResult )) {
		    $this->shipmentMethod = $arrayResult['${paramType.paramName}'];
		}
		if (array_key_exists ( "shipmentRelativeDuration", $this->arrayResult )) {
		    $this->shipmentRelativeDuration = $arrayResult['${paramType.paramName}'];
		}
		if (array_key_exists ( "shipmentRelativeField", $this->arrayResult )) {
		    $this->shipmentRelativeField = $arrayResult['${paramType.paramName}'];
		}
		if (array_key_exists ( "shipmentRelativeStart", $this->arrayResult )) {
		    $this->shipmentRelativeStart = $arrayResult['${paramType.paramName}'];
		}
		...
		if (array_key_exists ( "telephoneArea", $this->arrayResult )) {
		    $this->telephoneArea = $arrayResult['${paramType.paramName}'];
		}
		if (array_key_exists ( "telephoneCountryv", $this->arrayResult )) {
		    $this->telephoneCountryv = $arrayResult['${paramType.paramName}'];
		}
		if (array_key_exists ( "tradeTerm", $this->arrayResult )) {
		    $this->tradeTerm = $arrayResult['${paramType.paramName}'];
		}
	}
}
