...
use com\alibaba\trade\param\AlibabaOceanOpenplatformCommonOrderRefundReasonListResult;
...
class AlibabaTradeGetRefundReasonListResult {
	...
	/**
	 * 设置返回结果
	 * @param \com\alibaba\trade\param\AlibabaOceanOpenplatformCommonOrderRefundReasonListResult $result
	 * 此参数必填
	 */
